...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String userberhasillogin = getIntent().getStringExtra("USERNAME");
        ...
        navUsername.setText(""+userberhasillogin);
        Toast.makeText(getApplicationContext(),"Welcome" + userberhasillogin,Toast.LENGTH_SHORT).show();
